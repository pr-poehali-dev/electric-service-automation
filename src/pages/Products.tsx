...
import { PRODUCTS, MASTER_VISIT_ID } from '@/types/electrical';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 pb-32">
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-6">Электромонтажные работы</h2>
            ...
            {containers.map((container, containerIndex) => (
              <Card key={container.productId} className="overflow-hidden">
                <div 
                  ...
                  onClick={() => toggleContainer(containerIndex)}
                >
                  <div className="flex-1">
                    <h3 className="font-semibold text-base">{container.productName}</h3>
                          ...
                          {option.enabled ? (
                            <div className="flex items-center gap-2">
                              <Button
                                ...
                                onClick={(e) => {
                                  e.stopPropagation();
                                  updateOptionQuantity(containerIndex, option.id, option.quantity - 1);
                                }}
